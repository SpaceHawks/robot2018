...
Your duties include:
	Providing methods of sending and receiving a single integer or array of integers.
...
Requirement:
	Use Python or C++. If you have the implementations in both languages, that's even better.
